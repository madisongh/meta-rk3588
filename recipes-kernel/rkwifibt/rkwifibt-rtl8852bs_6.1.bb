...
MAKE_TARGETS = "-C ${STAGING_KERNEL_DIR} M=${S} modules DRV_PATH=${S} CONFIG_RTW_DEBUG=n CONFIG_PROC_DEBUG=n CONFIG_RTW_LOG_LEVEL=0 CONFIG_RTL8852BS=m"
MAKE_TARGETS += 'USER_EXTRA_CFLAGS="-Wno-error=header-guard"'
