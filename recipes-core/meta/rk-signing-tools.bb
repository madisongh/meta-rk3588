...
signing bootloaders and kernel images for Rockchip secure boot."
LICENSE = "MIT"
...
TOOLCHAIN_OUTPUTNAME ?= "${SDK_ARCH}-rk-signing-tools-${DISTRO_VERSION}"

SDK_TITLE = "Rockchip signing tools"
